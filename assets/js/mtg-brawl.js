...
async function generateCommanders(mode = 'pauper') {
    ...
    // rarity>uncommon in:arena format:brawl is:commander
    const baseURL = `https://api.scryfall.com/cards/random?q=${encodeURIComponent(rarityQuery)}%20in%3Aarena%20format%3Abrawl%20is%3Acommander`;
