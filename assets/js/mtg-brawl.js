...
async function generateCommanders(mode = 'pauper') {
    ...
    const baseURL = `https://api.scryfall.com/cards/random?q=type%3Alegendary%20type%3Acreature%20${encodeURIComponent(rarityQuery)}%20in%3Aarena%20format%3Abrawl`;
